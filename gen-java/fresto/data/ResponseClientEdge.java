...
public class ResponseClientEdge implements org.apache.thrift.TBase<ResponseClientEdge, ResponseClientEdge._Fields>, java.io.Serializable, Cloneable, Comparable<ResponseClientEdge> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ResponseClientEdge");
  ...
  static {
    schemes.put(StandardScheme.class, new ResponseClientEdgeStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ResponseClientEdgeTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ResponseClientEdge.class, metaDataMap);
  }

  public ResponseClientEdge() {
  }
   ...
   */
  public ResponseClientEdge(ResponseClientEdge other) {
  ...
  public ResponseClientEdge deepCopy() {
    return new ResponseClientEdge(this);
  }
  ...
  public ResponseClientEdge setResponse(ResponseID response) {
    this.response = response;
    return this;
  }
  ...
  public ResponseClientEdge setClient(ClientID client) {
    this.client = client;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ResponseClientEdge)
      return this.equals((ResponseClientEdge)that);
    return false;
  }

  public boolean equals(ResponseClientEdge that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ResponseClientEdge other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ResponseClientEdge(");
    boolean first = true;
  ...
  private static class ResponseClientEdgeStandardSchemeFactory implements SchemeFactory {
    public ResponseClientEdgeStandardScheme getScheme() {
      return new ResponseClientEdgeStandardScheme();
    }
  }

  private static class ResponseClientEdgeStandardScheme extends StandardScheme<ResponseClientEdge> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ResponseClientEdge struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ResponseClientEdge struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ResponseClientEdgeTupleSchemeFactory implements SchemeFactory {
    public ResponseClientEdgeTupleScheme getScheme() {
      return new ResponseClientEdgeTupleScheme();
    }
  }

  private static class ResponseClientEdgeTupleScheme extends TupleScheme<ResponseClientEdge> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ResponseClientEdge struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ResponseClientEdge struct) throws org.apache.thrift.TException {
