...
public class ManagedResourceID extends org.apache.thrift.TUnion<ManagedResourceID, ManagedResourceID._Fields> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ManagedResourceID");
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ManagedResourceID.class, metaDataMap);
  }

  public ManagedResourceID() {
    super();
  }

  public ManagedResourceID(_Fields setField, Object value) {
    super(setField, value);
  }

  public ManagedResourceID(ManagedResourceID other) {
    super(other);
  }
  public ManagedResourceID deepCopy() {
    return new ManagedResourceID(this);
  }

  public static ManagedResourceID servlet_path(String value) {
    ManagedResourceID x = new ManagedResourceID();
  ...
  public boolean equals(Object other) {
    if (other instanceof ManagedResourceID) {
      return equals((ManagedResourceID)other);
    } else {
      return false;
    }
  }

  public boolean equals(ManagedResourceID other) {
    return other != null && getSetField() == other.getSetField() && getFieldValue().equals(other.getFieldValue());
  }

  @Override
  public int compareTo(ManagedResourceID other) {
