...
public class JdbcCallEdge implements org.apache.thrift.TBase<JdbcCallEdge, JdbcCallEdge._Fields>, java.io.Serializable, Cloneable, Comparable<JdbcCallEdge> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("JdbcCallEdge");

  private static final org.apache.thrift.protocol.TField JDBC_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("jdbcId", org.apache.thrift.protocol.TType.STRUCT, (short)2);
  ...
  static {
    schemes.put(StandardScheme.class, new JdbcCallEdgeStandardSchemeFactory());
    schemes.put(TupleScheme.class, new JdbcCallEdgeTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(JdbcCallEdge.class, metaDataMap);
  }
   ...
   */
  public JdbcCallEdge(JdbcCallEdge other) {
  ...
  public JdbcCallEdge deepCopy() {
    return new JdbcCallEdge(this);
  }
  ...
  public JdbcCallEdge setJdbcId(JdbcID jdbcId) {
    this.jdbcId = jdbcId;
    return this;
  }
  ...
  public JdbcCallEdge setTimestamp(long timestamp) {
    this.timestamp = timestamp;
    setTimestampIsSet(true);
    return this;
  }
  ...
  public JdbcCallEdge setUuid(String uuid) {
    this.uuid = uuid;
    return this;
  }
  ...
  public JdbcCallEdge setSequence(int sequence) {
    this.sequence = sequence;
    setSequenceIsSet(true);
    return this;
  }
  ...
  public JdbcCallEdge setDepth(int depth) {
    this.depth = depth;
    setDepthIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof JdbcCallEdge)
      return this.equals((JdbcCallEdge)that);
    return false;
  }

  public boolean equals(JdbcCallEdge that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(JdbcCallEdge other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("JdbcCallEdge(");
    boolean first = true;
  ...
  private static class JdbcCallEdgeStandardSchemeFactory implements SchemeFactory {
    public JdbcCallEdgeStandardScheme getScheme() {
      return new JdbcCallEdgeStandardScheme();
    }
  }

  private static class JdbcCallEdgeStandardScheme extends StandardScheme<JdbcCallEdge> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, JdbcCallEdge struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, JdbcCallEdge struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class JdbcCallEdgeTupleSchemeFactory implements SchemeFactory {
    public JdbcCallEdgeTupleScheme getScheme() {
      return new JdbcCallEdgeTupleScheme();
    }
  }

  private static class JdbcCallEdgeTupleScheme extends TupleScheme<JdbcCallEdge> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, JdbcCallEdge struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, JdbcCallEdge struct) throws org.apache.thrift.TException {
