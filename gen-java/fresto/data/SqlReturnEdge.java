...
public class SqlReturnEdge implements org.apache.thrift.TBase<SqlReturnEdge, SqlReturnEdge._Fields>, java.io.Serializable, Cloneable, Comparable<SqlReturnEdge> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("SqlReturnEdge");

  private static final org.apache.thrift.protocol.TField SQL_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("sqlId", org.apache.thrift.protocol.TType.STRUCT, (short)1);
  ...
  static {
    schemes.put(StandardScheme.class, new SqlReturnEdgeStandardSchemeFactory());
    schemes.put(TupleScheme.class, new SqlReturnEdgeTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(SqlReturnEdge.class, metaDataMap);
  }

  public SqlReturnEdge() {
  }
   ...
   */
  public SqlReturnEdge(SqlReturnEdge other) {
  ...
  public SqlReturnEdge deepCopy() {
    return new SqlReturnEdge(this);
  }
  ...
  public SqlReturnEdge setSqlId(SqlID sqlId) {
    this.sqlId = sqlId;
    return this;
  }
  ...
  public SqlReturnEdge setTimestamp(long timestamp) {
    this.timestamp = timestamp;
    setTimestampIsSet(true);
    return this;
  }
  ...
  public SqlReturnEdge setElapsedTime(int elapsedTime) {
    this.elapsedTime = elapsedTime;
    setElapsedTimeIsSet(true);
    return this;
  }
  ...
  public SqlReturnEdge setUuid(String uuid) {
    this.uuid = uuid;
    return this;
  }
  ...
  public SqlReturnEdge setSequence(int sequence) {
    this.sequence = sequence;
    setSequenceIsSet(true);
    return this;
  }
  ...
  public SqlReturnEdge setDepth(int depth) {
    this.depth = depth;
    setDepthIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof SqlReturnEdge)
      return this.equals((SqlReturnEdge)that);
    return false;
  }

  public boolean equals(SqlReturnEdge that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(SqlReturnEdge other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("SqlReturnEdge(");
    boolean first = true;
  ...
  private static class SqlReturnEdgeStandardSchemeFactory implements SchemeFactory {
    public SqlReturnEdgeStandardScheme getScheme() {
      return new SqlReturnEdgeStandardScheme();
    }
  }

  private static class SqlReturnEdgeStandardScheme extends StandardScheme<SqlReturnEdge> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, SqlReturnEdge struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SqlReturnEdge struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class SqlReturnEdgeTupleSchemeFactory implements SchemeFactory {
    public SqlReturnEdgeTupleScheme getScheme() {
      return new SqlReturnEdgeTupleScheme();
    }
  }

  private static class SqlReturnEdgeTupleScheme extends TupleScheme<SqlReturnEdge> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, SqlReturnEdge struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, SqlReturnEdge struct) throws org.apache.thrift.TException {
