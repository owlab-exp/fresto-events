...
public class ReceiveResponseEdge implements org.apache.thrift.TBase<ReceiveResponseEdge, ReceiveResponseEdge._Fields>, java.io.Serializable, Cloneable, Comparable<ReceiveResponseEdge> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ReceiveResponseEdge");
  ...
  static {
    schemes.put(StandardScheme.class, new ReceiveResponseEdgeStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ReceiveResponseEdgeTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ReceiveResponseEdge.class, metaDataMap);
  }

  public ReceiveResponseEdge() {
  }
   ...
   */
  public ReceiveResponseEdge(ReceiveResponseEdge other) {
  ...
  public ReceiveResponseEdge deepCopy() {
    return new ReceiveResponseEdge(this);
  }
  ...
  public ReceiveResponseEdge setClient(ClientID client) {
    this.client = client;
    return this;
  }
  ...
  public ReceiveResponseEdge setResponse(ResponseID response) {
    this.response = response;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ReceiveResponseEdge)
      return this.equals((ReceiveResponseEdge)that);
    return false;
  }

  public boolean equals(ReceiveResponseEdge that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ReceiveResponseEdge other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ReceiveResponseEdge(");
    boolean first = true;
  ...
  private static class ReceiveResponseEdgeStandardSchemeFactory implements SchemeFactory {
    public ReceiveResponseEdgeStandardScheme getScheme() {
      return new ReceiveResponseEdgeStandardScheme();
    }
  }

  private static class ReceiveResponseEdgeStandardScheme extends StandardScheme<ReceiveResponseEdge> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ReceiveResponseEdge struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ReceiveResponseEdge struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ReceiveResponseEdgeTupleSchemeFactory implements SchemeFactory {
    public ReceiveResponseEdgeTupleScheme getScheme() {
      return new ReceiveResponseEdgeTupleScheme();
    }
  }

  private static class ReceiveResponseEdgeTupleScheme extends TupleScheme<ReceiveResponseEdge> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ReceiveResponseEdge struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ReceiveResponseEdge struct) throws org.apache.thrift.TException {
